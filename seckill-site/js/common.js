		...
		'<div class="modal" id="captcha-box" tabindex="-1" role="dialog">'+
			'<div class="modal-dialog" role="document" style="margin:100px auto;">'+
				'<div class="modal-content">'+
					...
					'<div class="modal-body">'+
						'<p>'+
                            '<a href="javascript:void(0);"><img src="" class="" id="captchaImg" style="display:inline-block;width:130px;height:48px;" /></a>&nbsp;&nbsp;'+
                            '<input type="text" class="form-control" id="captchaText" style="display:inline-block;width:130px;height:48px;margin-top:111;" placeholder="请输入验证码"/>'+
                        '</p>'+
					'</div>'+
					'<div class="modal-footer">'+
						'<button type="button" class="btn btn-secondary" data-dismiss="modal">确定</button>'+
